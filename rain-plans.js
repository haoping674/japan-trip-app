(function (root, factory) {
  ...
  return {
    ...
    3: {
      title: "白鬚神社後，順路進小濱",
      summary: "白鬚神社照常前往，取消兒童公園野餐與出海；走熊川宿的室內休息站，進小濱後一路接到住宿。",
      trigger: "白鬚神社後持續降雨、湖畔／公園不適合停留，或 15:30 蘇洞門遊船未確認安全營運時啟用。",
      stops: [
        { time: "09:53", place: "白鬚神社", note: "照原定前往；雨勢大時只在停車場側短暫參拜／拍攝，不要為了湖中鳥居橫越車流快、路面濕滑的國道 161 號。" },
        { time: "11:15", place: "道之驛 若狹熊川宿", note: "沿湖西往若狹的路上先用餐、休息；賣店、食堂與鯖街道博物館皆在室內。9/8（週二）不是其 9 月第二個週四休館日。" },
        { time: "13:15", place: "御食國若狹小濱食文化館", note: "進入小濱後參觀室內的鯖街道、若狹飲食與工藝展示；9/8 週二正常開館，9:00–18:00，免入館費。" },
        { time: "14:20", place: "若狹漁人碼頭", note: "食文化館旁的室內賣店採買晚餐／伴手禮；雨天備案不搭 15:30 遊船。是否保留或處理原預約，先以業者當日公告為準。" },
        { time: "15:00", place: "Party&Resort ZERO'sHOUSE", note: "最後一站直接入住（小濱市小濱大宮 92；15:00 起可辦理入住），不再折返三丁町或湖畔。" },
      ],
      sources: [
        { label: "道之驛 若狹熊川宿（營業資訊）", url: "https://kumagawajuku.jp/smp/access.html" },
        { label: "御食國若狹小濱食文化館", url: "https://wakasa-obama.jp/spot/miketukuni-syokubunkakan/" },
        { label: "Party&Resort ZERO'sHOUSE（入住資訊）", url: "https://www.chillnn.com/ja/19366fef87e292" },
      ],
    },
    4: {
      title: "赤煉瓦後，雨天直達宮津",
      summary: "赤煉瓦博物館已完成；省下天橋立、伊根與海岸繞行，原地室內用餐後一路進宮津採買並入住。",
      trigger: "赤煉瓦博物館已完成且持續降雨、海岸風雨大或傘松公園視野不佳時啟用；今天不為打卡硬開海岸線。",
      stops: [
        { time: "已完成", place: "舞鶴市立赤煉瓦博物館", note: "已完成參觀，不再安排紅磚館或港區折返。" },
        { time: "12:10", place: "舞鶴赤れんがパーク cafe jazz", note: "博物館旁 2 號棟 1F 室內午餐／咖啡休息（10:00–17:00，L.O. 16:00）；若已用餐，12:45 直接往宮津。" },
        { time: "13:50", place: "宮津シーサイドマート Mipple", note: "抵達宮津後在室內補齊晚餐、隔日早餐與雨具；5 樓山海屋可用餐（11:00–22:00），離今晚住宿只約 5 分鐘車程。" },
        { time: "15:00", place: "KYOTO TANGO MIYAZU inn", note: "最後一站直接入住（宮津市萬町 602；15:00 起），不再前往天橋立、伊根或今天店鋪臨休的道之驛海之京都宮津。" },
      ],
      sources: [
        { label: "舞鶴赤煉瓦公園／cafe jazz", url: "https://akarenga-park.com/" },
        { label: "宮津 Mipple 山海屋（營業資訊）", url: "https://www.sato-kyoto.com/sankaiya/" },
        { label: "道之驛海之京都宮津（9/9 臨時休業公告）", url: "https://michinoeki-miyazu.jp/info/article.php?slug=%25e3%2580%2590%25e9%2587%258d%25e8%25a6%2581%25e3%2580%2591%25e9%25a4%25a8%25e5%2586%2585%25e5%25ba%2597%25e8%2588%2597%25e3%2581%25ae%25e8%2587%25a8%25e6%2599%2582%25e4%25bc%2591%25e6%25a5%25ad%25e3%2581%258a%25e3%2582%2588%25e3%2581%25b3%25e5%2596%25b6%25e6%25a5%25ad%25e6%2599%2582%25e9%2596%2593%25e5%25a4%2589%25e6%259b%25b4" },
      ],
    },
    5: {
      title: "北大阪生物美術館",
