...
| `sw.js` | `osaka-travel-v66` 的離線 App Shell。 |
...
每次修改 `index.html`、`styles.css`、`app.js`、manifest、圖示或會影響快取資料的 API 行為時，都要同步更新 `sw.js` 的 `CACHE_NAME` 與資源版本 query，避免已安裝的 PWA 顯示舊版。目前為 `osaka-travel-v66`。
