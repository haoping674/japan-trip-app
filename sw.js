...
self.addEventListener("fetch", (event) => {
  ...
  if (requestUrl.pathname === "/api/state" && requestUrl.searchParams.has("vault")) {
  ...
  if (["/api/state", "/api/expenses"].includes(requestUrl.pathname)) return;
